...
class HaystackConnection():
    ...
    def getJson(self,urlToGet):
        ...
        """
        try:
            req = self.s.get(urlToGet, headers={'accept': 'application/json; charset=utf-8'})
    ...
    def getZinc(self,urlToGet):
        ...
        """
        try:
            req = self.s.get(urlToGet, headers={'accept': 'text/plain; charset=utf-8'})
            #print 'GET : %s | url : %s' % (req.text, urlToGet)
            return (req.text)
        except requests.exceptions.RequestException as e:    # This is the correct syntax
            print 'Request GET error : %s' % e
    ...
    def postRequest(self,url,headers={'token':''}):
        ...
        try:
            ...
            #print 'POST : %s | url : %s | headers : %s | auth : %s' % (req, url, headers,self.USERNAME)
        except requests.exceptions.RequestException as e:    # This is the correct syntax
...
class NiagaraAXConnection(HaystackConnection):
    ...
    def __init__(self,url,username,password):
        ...
        self.requestAbout = self.queryURL + "about"
        self.authenticate()
    ...
    def authenticate(self):
        ...
        """
        print 'Authentication to %s' % self.loginURL
        try:
...
class Histories():
    ...
    def __init__(self, session):
        self.hisListName = []
        self.hisListId = []
        requestHistories = session.queryURL + "read?filter=his"
...
class HisRecord():
    ...
    def __init__(self,session,hisId,dateTimeRange):
        ...
        """
        self.hisId = hisId
        self.jsonHis = session.getJson(session.queryURL+'hisRead?id='+self.hisId+'&range='+dateTimeRange)
        try:
